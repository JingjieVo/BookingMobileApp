...
function Profile(): React.JSX.Element{
  ...
  return (
    ...
    <ScrollView style={{flex: 1,backgroundColor: "#FFFFFF", marginBottom: 87}}>
      <View style={[styles.container, {backgroundColor: "#F3F1FD"}]}>
        <View>
          <Text style={{fontSize: 60, padding: 20, color: '#000000', fontWeight: '600'}}>Đăng nhập vào<Text style= {{color: '#56e865', fontWeight: '600'}}>Tài khoản</Text> </Text>
        </View>
        <View>
        ...
        <View style={{ paddingTop: 20,alignSelf: 'center', flexDirection: 'row'}}>
          ...
          <TouchableOpacity style={{}}><Text style={{color: "#76A1F5"}}>Đăng kí ngay</Text></TouchableOpacity>
        </View>
      </View>
      <View>
        ...
        <TouchableOpacity style= {{paddingHorizontal: 30, paddingVertical: 25, flexDirection: 'row', justifyContent: 'space-between'}}>
          <View>
            ...
            <Text style={{fontSize: 15, fontWeight: '400', color: "gray", fontStyle: 'italic'}}>Đọc kỹ hướng dẫn trước khi đặt vé sẽ tránh được nhiều sai xót không đáng có</Text>
          </View>
